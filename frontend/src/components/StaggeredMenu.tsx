...
export function StaggeredMenu({
  ...
  // ---- 2j. Paksa tutup (dipakai klik di luar + klik item) ----
  ...
  // ---- 2l. Render: lapisan + header kapsul + panel ----
  return (
    <div
      ...
      data-open={open || undefined} // info buka untuk CSS
    >
      ...
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          ...
          const arr = [...raw]; // salin
          if (arr.length >= 3) arr.splice(Math.floor(arr.length / 2), 1); // 3+ warna: buang tengah
